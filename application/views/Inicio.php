            ...
            <div class="col-lg-12">
                            <form >  
                              <div class="form-group row justify-content-center">
                                  <div class="col-sm-5">
                                     <input type="email" class="form-control" id="staticEmail" placeholder="email@servidor.com">
                                  </div>    
                              </div>
                              ...
                              <div class="form-group row justify-content-center"  >
                                  <button type="button" class="btn btn-dark col-sm-2" id="btn-login" onclick="emptyEmail()"> Login  </button>
