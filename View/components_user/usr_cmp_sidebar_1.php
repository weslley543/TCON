      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?ref=usr_formulario"> Criar Ordem de Serviço </a>
            <a class="collapse-item" href="index.php?ref=usr_agendamentos"> Agendamentos </a>
